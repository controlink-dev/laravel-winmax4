...
class Winmax4DocumentTypesController extends Controller
{
    /**
     * @var Winmax4DocumentTypeService The service responsible for handling interactions with the Winmax4 API.
     */
    protected $winmax4Service;

    /**
     * Init Constructor for Winmax4DocumentTypesController.
     *
     * This constructor initializes the `Winmax4DocumentTypeService` based on the settings retrieved from the database.
    ...
    public function __construct()
    {
        ...
        if(!$winmaxSettings) {
            $this->winmax4Service = new Winmax4DocumentTypeService(true);
        }else{
            $this->winmax4Service = new Winmax4DocumentTypeService(
                false,
                $winmaxSettings->url,
    ...
    /**
     * Get document types from the Winmax4 API.
     *
     * This method queries the Winmax4DocumentType model using Eloquent ORM to fetch
     ...
     *
     * ```php
     * $response = $this->getDocumentTypes();
     * ```
     *
     * ### Response Format
     *
     * The response is a JSON-encoded array of objects, each representing a record from the
     * Winmax4DocumentType model. The format of each object corresponds to the columns of the
     ...
     * | Type          | Description                                                     |
     * |---------------|-----------------------------------------------------------------|
     * | `JsonResponse`| A JSON response containing the fetched document types with status 200.|
     *
     * ### Possible Exceptions
     *
     ...
     *
     * @return JsonResponse Returns a JSON response with all document types.
     */
