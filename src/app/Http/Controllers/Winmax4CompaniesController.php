...
class Winmax4CompaniesController extends Controller
{
    /**
     * @var Winmax4CompanyService The service responsible for handling interactions with the Winmax4 API.
     */
    ...
    public function __construct()
    {
        ...
        if(!$winmaxSettings) {
            $this->winmax4Service = new Winmax4CompanyService(true);
        }else{
            $this->winmax4Service = new Winmax4CompanyService(
                false,
                $winmaxSettings->url,
    ...
    {
        $companies = $this->winmax4Service->getCompanies();
