...
{
    /**
     * Get payment types from Winmax4 API
     *
     * This method sends a GET request to the specified URL endpoint to fetch a
     * list of payment types. It uses the Guzzle HTTP client for making the request and
     ...
     *
     * The method fetches data from the endpoint `/Files/PaymentTypes` and expects a
